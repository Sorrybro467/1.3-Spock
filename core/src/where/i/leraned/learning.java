...
import utils.TiledObUtils;

import static utils.constents.PPM;
...
public class learning extends ApplicationAdapter {
    ...
    public void create() {
       ...
       map = new TmxMapLoader().load("learing map.tmx");
        tmr = new OrthogonalTiledMapRenderer(map);
        
        TiledObUtils.parsedTiledObjectLayer(world, map.getLayers().get("collosin layer").getObjects());
    }
